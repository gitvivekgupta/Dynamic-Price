...
def scrap_hotel(all_data = {}):
    ...
    url_list = ['https://www.oyorooms.com/hotels-in-gurgaon/?filters%5Bcity_id%5D=1&filters%5Broom_pricing%5D%5Bmax%5D=3695&filters%5Broom_pricing%5D%5Bmin%5D=2009']
    ...
    for url in url_list:
        ...
        badge = soup.find_all('span', {"class": "listingBadge listingBadge--compact"})
