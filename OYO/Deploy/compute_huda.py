...
def compute_huda_avg(dlf_data):
    avg_price = round(dlf_data['Price'].mean(), 2)
    return avg_price

def compute_huda_index(todays_median):
    ...
    cyber_city_data = data["huda_city_center"]
