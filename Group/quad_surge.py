...
def quad_surge_arbor_price(oyo_med_price, base_price, price_index, property_data_dict={}):
    ...
    if price_index < 100:
        ...
        assign_arbor_price = oyo_med_price * price_index * 1.4
...
def quad_surge_golf_course_price(oyo_med_price, base_price, price_index, property_data_dict={}):
    ...
    if price_index < 100:
        ...
        price_index = (price_index/100)
        assign_golf_price = oyo_med_price * price_index * 1.4
...
def quad_surge_cyber_city_price(oyo_med_price, base_price, price_index, property_data_dict={}):
    ...
    if price_index < 100:
        ...
        price_index = (price_index/100)
        assign_cyber_price = oyo_med_price * price_index * 1.4
